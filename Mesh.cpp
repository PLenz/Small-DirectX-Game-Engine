                         ...
                         ComPtr<ID3D12CommandAllocator>& commandAllocator)
{
	if (!loaded) {
		...
		DWORD* iList;
		int vCount;
		ObjLoader::Load(std::string(m_objPath.begin(), m_objPath.end()), triangleVertices, vCount, iList, m_iListSize, m_boundingVolume);
...
bool Mesh::PopulateCommandList(ComPtr<ID3D12GraphicsCommandList>& commandList, D3D12_GPU_VIRTUAL_ADDRESS constantBufferUploadHeap)
{
