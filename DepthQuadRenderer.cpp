...
bool DepthQuadRenderer::LoadResources(ComPtr<ID3D12Device>& m_device, ComPtr<ID3D12GraphicsCommandList>& commandList,
...
bool DepthQuadRenderer::CreateDepthStencilBuffer(ComPtr<ID3D12Device>& device,
                                                 ComPtr<ID3D12GraphicsCommandList>& commandList, int width,
                                                 int height) {
  HRESULT hr;
...
bool DepthQuadRenderer::PopulateCommandList(ComPtr<ID3D12GraphicsCommandList>& commandList,
  ...
  commandList->
    SetGraphicsRootDescriptorTable(0, m_mainDescriptorHeap[frameIndex]->GetGPUDescriptorHandleForHeapStart());
