...
public:
	...
	bool PopulateCommandList(ComPtr<ID3D12GraphicsCommandList> &commandList, UINT8* constantBufferGPUAddress, D3D12_GPU_VIRTUAL_ADDRESS constantBufferUploadHeap);
	...
	Mesh* GetMesh();
	void SetCull(bool cullModel, ComPtr<ID3D12GraphicsCommandList>& commandList, ComPtr<ID3D12CommandAllocator>& commandAllocator);
